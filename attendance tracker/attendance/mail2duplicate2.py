...
jwt = JWTManager(app)
mail = Mail(app)
swagger = Swagger(app, template_file=r'C:\Users\shanmugaSundar E\PycharmProjects\flaskdemo\attendance tracker\attendance\swagger_doc\swagger.yaml')
...
def add_user():
    try:
        ...
        if not all([username, email, password]):
            return jsonify({'message': 'username or email or password missing please provide'}), 400
